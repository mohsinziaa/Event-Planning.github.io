...
if(isset($_POST['productID'])){
 ...
 // $projImage = $_POST['projectImage'];
    ...
    $image=$_FILES['hallImage']['name'];
    $target =  "hall_images/".basename($image);
    ...
    if($con->query($sql) == true){
        ...
        move_uploaded_file($_FILES['hallImage']['tmp_name'],$target);
        $insert=true;
    }
...
<body>
    ...
    <div class="outerContainer">
        <nav class="form-box">
            ...
            <form action="hallsProvider.php" method="post" enctype="multipart/form-data">
                <h1>Enter Your Details</h1>

                <input type="text" name="userID" id="userID" placeholder="Enter Your UserID" required>
                <input type="text" name="productID" id="productID" placeholder="Enter A Product ID" required>
                <input type="text" name="productName" id="productName" placeholder="Enter Your Hall Name" required>
                <input type="text" name="productPrice" id="productPrice" placeholder="Enter Price of Hall" required>
                <textarea name="productAddress" id="productAddress" cols="40" rows="3"
                placeholder="Enter the complete address of your hall"></textarea>

                <input type="file" name="hallImage" id="hallImage" required>
                <div class="buttons">
    ...
    <?php   
    if($insert == true){
        echo  "<h1 id='after-submit'>Your Hall Was Published For Booking</h1>";
    }
    ?>
