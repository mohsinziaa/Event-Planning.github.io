...
if(isset($_POST['productID'])){
    ...
    $sql=" INSERT INTO `projectdb`.`buyerTable` (`userID`, `productID`, `buyerContact`, `cateogary`, `date`) 
    VALUES ('$userID','$productID','$buyerContact', '$cateogary', '$bookingDate');";
...
<head>
    ...
    <title>photographerBooking</title>
