...
<body>
    ...
    <div class="outerContainer">
        <nav class="form-box">
            ...
            <form action="hotelProvider.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="productName" id="productName" placeholder="Enter Your Hotel Name" required>
                <input type="text" name="productPrice" id="productPrice" placeholder="Enter Price of Room" required>
                <textarea name="productAddress" id="productAddress" cols="40" rows="3"
                placeholder="Enter the complete address of your Hotel"></textarea>
    ...
    <?php   
    if($insert == true){
        echo  "<h1 id='after-submit'>Your hotel was published for booking</h1>";
    }
    else{
        echo "Die";
    }
