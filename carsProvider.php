...
if(isset($_POST['productID'])){
 ...
 // $projImage = $_POST['projectImage'];
    ...
    $target =  "car_images/".basename($image);
...
<body>
    ...
    <div class="outerContainer">
        <nav class="form-box">
            ...
            <form action="carsProvider.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="productName" id="productName" placeholder="Enter Your Car Name" required>
                <input type="text" name="productPrice" id="productPrice" placeholder="Enter rent of the car" required>
    ...
    <?php   
    if($insert == true){
        echo  "<h1 id='after-submit'>Your car was published for booking</h1>";
    }
    else{
        echo "Die";
    }
